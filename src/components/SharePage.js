    ...
    return (
      <TouchableOpacity style={styles.touchableOpacityContainer} >
        <View style={styles.container}>
          ...
          {this.renderTouchableOpacityImage(require('../images/wechat_fri.png'), this.shareToSession)}
          {this.renderTouchableOpacityImage(require('../images/wechat_moments.png'), this.shareToTimeline)}
          {this.renderTouchableOpacityImage(require('../images/copylink.png'), this.setToClipboard)}
        </View>
      </TouchableOpacity>
    );
  }
